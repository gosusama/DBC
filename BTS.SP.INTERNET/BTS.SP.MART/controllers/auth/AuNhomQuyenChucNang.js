...
define(['ui-bootstrap', '/BTS.SP.MART/controllers/auth/AuMenu.js'], function () {
    ...
    /* controller list */
    app.controller('AuNhomQuyenChucNangConfigCtrl', ['$scope', '$uibModalInstance', 'configService', 'AuNhomQuyenChucNangChucNangService', 'tempDataService', '$filter', 'toaster', 'AuMenuService', 'targetData',
        function ($scope, $uibModalInstance, configService, service, tempDataService, $filter, toaster, AuMenuService, targetData) {
            $scope.config = {
            ...
            $scope.deSelectChucNangEdit = function (item) {
                ...
                if (index >= 0) {
                    ...
                    AuMenuService.getByMenuId(item.machucnang).then(function (successRes) {
                        if (successRes.data) {
