...
{
    public class NvKhuyenMaiComboVm
    {
        ...
        public class Dto : DataInfoDtoVm
        {
            ...
            public List<DtoDetail> DataGifts { get; set; }
        }
        ...
        public class ListCombo
        {
            public ListCombo()
            {
                ListComboLeft = new List<ListCombo>();
                ListComboRight = new List<ListCombo>();
            }
            public List<ListCombo> ListComboLeft { get; set; }
            public List<ListCombo> ListComboRight { get; set; }
            public decimal SoLuongKhuyenMai { get; set; }
            public string MaChuongTrinh { get; set; }
            public decimal GiaTriKhuyenMai { get; set; }
            public string MaVatTuLeft { get; set; }
            public string MaVatTuRight { get; set; }
        }

        public class ObjImportExcelCombo
        {
            public decimal SoThuTu { get; set; }
            public string MaHang { get; set; }
            public string TenHang { get; set; }
            public string MaHangKhuyenMai { get; set; }
            public string TenHangKhuyenMai { get; set; }
        }
    }
}
