...
BEGIN
P_COLUMNS_GROUPBY:= 'g.MALOAITHUE, t.UNITCODE';
P_SELECT_COLUMNS_OUT_GROUPBY:= 'c.MALOAITHUE AS Ma, c.LOAITHUE AS Ten,a.UNITCODE AS MADONVIXUAT  ';
P_SELECT_COLUMNS_IN_GROUPBY:= ' g.MALOAITHUE AS MA, t.UNITCODE ';
...
BEGIN
P_COLUMNS_GROUPBY:= 't.NOIDUNG, t.UNITCODE, t.MACHUNGTUPK';
