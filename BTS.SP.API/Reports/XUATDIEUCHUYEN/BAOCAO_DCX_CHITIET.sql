...
P_SELECT_COLUMNS_OUT_GROUPBY:= 'a.MA AS MaCon, a.TEN AS TenCon,a.BARCODE AS BARCODE, c.MADONVI AS MaCha,  c.TENDONVI  AS TenCha,a.NGAYCHUNGTU AS NgayGiaoDich ';
P_SELECT_COLUMNS_IN_GROUPBY:= 'b.MAVATTU AS MA, b.TENVATTU AS TEN,b.BARCODE AS BARCODE , t.MADONVIXUAT AS GROUPCODE,t.NGAYCHUNGTU AS NGAYCHUNGTU ';
P_TABLE_GROUPBY:= ' INNER JOIN AU_DONVI c ON a.GROUPCODE = c.MADONVI ';
END;
ELSIF P_GROUPBY = 'MALOAITHUE' THEN
BEGIN
P_COLUMNS_GROUPBY:= 'b.MAVATTU, b.TENVATTU,b.BARCODE, g.MALOAITHUE,t.NGAYCHUNGTU';
...
P_SELECT_COLUMNS_IN_GROUPBY:= 'b.MAVATTU AS MA, b.TENVATTU AS TEN,b.BARCODE AS BARCODE , g.MALOAITHUE AS GROUPCODE,t.NGAYCHUNGTU AS NGAYCHUNGTU ';
...
END IF;
 ...
 QUERY_STR := 'select (a.SOLUONGBAN) as SOLUONGBAN, a.DONGIANHAP, (a.TIENTHUE) AS TIENTHUE,(a.DOANHTHU) AS DOANHTHU,(a.DOANHTHU + a.TIENTHUE) AS TONGBAN, (a.TIENCHIETKHAU) AS TIENCHIETKHAU, 
...
--------------------------------------------------------
--  DDL for Procedure BAOCAO_DCX_CHITIET
--------------------------------------------------------