...
{
    [RoutePrefix("api/Ac/LanDauKh")]
    [Route("{id?}")]
    [Authorize]
    public class LanDauKhController:ApiController
    {
        private readonly ILanDauKhService _service;
        private readonly IMdPeriodService _servicePeriod;
        public LanDauKhController(ILanDauKhService service, IMdPeriodService servicePeriod)
        {
            _service = service;
