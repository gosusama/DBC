   ...
   -- NHẬP MUA
    P_SQL_INSERT := 'INSERT INTO XUATNHAPTON_TEMP (MAVATTU, MALOAIVATTU, MANHOMVATTU,MANHACUNGCAP,MAKHO,SOLUONG,DONGIA,THANHTIEN,UNITCODE, LOAICHUNGTU,NGAYCHUNGTU,NGAYDUYETPHIEU)
         ...
         (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
          ...
          VATTUCHUNGTU.NGAYDUYETPHIEU AS NGAYDYETPHIEU
          FROM VATTUCHUNGTU
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''NMUA'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';        
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''DCX'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''DCN'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''XBANLE'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''NHBANTL'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''DCX_BO'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''XKHAC'' AND MALYDOKHAC =''X11'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''XKHAC'' AND MALYDOKHAC =''X1'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''XKHAC'' AND MALYDOKHAC =''X12'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
           ...
           --XUẤT ĐIỀU CHỈNH
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''XKHAC'' AND MALYDOKHAC =''X2'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''XKHAC'' AND MALYDOKHAC IS NULL AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''NKHAC'' AND MALYDOKHAC =''N3'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''NKHAC'' AND MALYDOKHAC =''N2'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT DMVATTU.MAKHACHHANG FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS MANHACUNGCAP,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''DCN'' AND VATTUCHUNGTU.MADONVIXUAT = VATTUCHUNGTU.UNITCODE AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            (SELECT DMVATTU.MAKHACHHANG FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS MANHACUNGCAP,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''DCX'' AND VATTUCHUNGTU.MADONVINHAN = VATTUCHUNGTU.UNITCODE AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            UNION ALL 
             ...
             (SELECT MANHOMVATTU FROM DMVATTU WHERE DMVATTU.MAVATTU = VATTUCHUNGTUCHITIET.MAHANG) AS  MANHOMVATTU,
              ...
              INNER JOIN VATTUCHUNGTUCHITIET
              ON (VATTUCHUNGTU.MACHUNGTUPK = VATTUCHUNGTUCHITIET.MACHUNGTUPK)
              WHERE VATTUCHUNGTU.LOAICHUNGTU = ''XBAN'' AND TRANGTHAI = 10 AND TO_DATE(NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            P_SQL_INSERT := P_SQL_INSERT||' AND VATTUCHUNGTU.MAKHONHAP IN ('''||P_WAREHOUSE||''')';
            END IF;
            IF TRIM(P_MALOAI) IS NOT NULL THEN
            ...
            FROM NVGDQUAY_ASYNCCLIENT gdquay
               INNER JOIN NVHANGGDQUAY_ASYNCCLIENT hanggdquay
                  ...
                  WHERE TO_DATE(gdquay.NGAYPHATSINH,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';  
                   IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
            ...
            TO_NCHAR(''KIEMKE'') AS LOAICHUNGTU,
            ...
            WHERE TRANGTHAI = 10 AND TO_DATE(kiemke.NGAYDUYETPHIEU,''DD/MM/YY'') BETWEEN TO_DATE('''||P_TUNGAY||''', ''DD/MM/YY'') AND TO_DATE('''||P_DENNGAY||''', ''DD/MM/YY'')';
            IF TRIM(P_WAREHOUSE) IS NOT NULL THEN
        ...
        NVL(a.KIEMKE_SUM_SOLUONG,0) AS KIEMKE_SL, NVL(a.KIEMKE_SUM_THANHTIEN,0) AS KIEMKE_GT,
        ...
        FROM (
            ...
            PIVOT ( SUM(SOLUONG) AS SUM_SOLUONG, SUM(NVL(THANHTIEN,0)) as SUM_THANHTIEN
              FOR LOAICHUNGTU
              IN (''1'' AS XUATBANLEQUAY,''2'' AS XUATBANLETRALAI, ''NMUA'' AS NMUA, ''KIEMKE'' AS KIEMKE, ''NHAPCHUYENKHO'' AS NHAPCHUYENKHO, ''NHAPSTTHANHVIEN'' AS NHAPSTTHANHVIEN, ''XUATCHUYENKHO'' AS XUATCHUYENKHO, 
        ...
        --Group sau khi Pivot
        QUERY_STR  :=' SELECT U.MAVATTU,U.MALOAIVATTU, U.MANHOMVATTU, U.UNITCODE,U.MAKHO,
        ...
        SUM(U.KIEMKE_SL) AS KIEMKE_SL, SUM(U.KIEMKE_GT) AS KIEMKE_GT,
        ...
        FROM ('||QUERY_STR||') U 
        GROUP BY U.MAVATTU,U.MALOAIVATTU, U.MANHOMVATTU, U.UNITCODE, U.MAKHO
        '; 
        ...
        RESULT_STR:=' SELECT D.MAVATTU,D.TENVATTU,D.MALOAIVATTU,D.MANHOMVATTU,D.UNITCODE,D.XBANLEQUAY_SL,D.XBANLEQUAY_GT,
         D.XBANLETL_SL, D.XBANLETL_GT,D.NMUA_SL,D.NMUA_GT,D.KIEMKE_SL,D.KIEMKE_GT,D.NHAPCHUYENKHO_SL,D.NHAPCHUYENKHO_GT,D.NHAPSTTHANHVIEN_SL,D.NHAPSTTHANHVIEN_GT,
         ...
         FROM ('||RESULT_STR||') D 
         GROUP BY D.MAVATTU,D.TENVATTU,D.MALOAIVATTU,D.MANHOMVATTU,D.UNITCODE,D.XBANLEQUAY_SL,D.XBANLEQUAY_GT,
         D.XBANLETL_SL, D.XBANLETL_GT,D.NMUA_SL,D.NMUA_GT,D.KIEMKE_SL,D.KIEMKE_GT,D.NHAPCHUYENKHO_SL,D.NHAPCHUYENKHO_GT,D.NHAPSTTHANHVIEN_SL,D.NHAPSTTHANHVIEN_GT,
         D.XUATCHUYENKHO_SL,D.XUATCHUYENKHO_GT,D.XUATSTTHANHVIEN_SL,D.XUATSTTHANHVIEN_GT,D.XBANLE_SL,D.XBANLE_GT,D.XUATBANBUON_SL,D.XUATBANBUON_GT,
         D.NHAPDIEUCHINH_SL,D.NHAPDIEUCHINH_GT,NHAPHANGAM_SL,D.NHAPHANGAM_GT,D.XUATHUYHH_SL,D.XUATHUYHH_GT,D.XUATHUY_SL,D.XUATHUY_GT,
         D.XUATTRANCC_SL,D.XUATTRANCC_GT,D.XUATDC_SL,D.XUATDC_GT,D.NHAPBANTL_SL,D.NHAPBANTL_GT
        ...
        RESULT_STR:=' SELECT X.MAVATTU,X.TENVATTU,X.MALOAIVATTU,X.MANHOMVATTU,X.UNITCODE,SUM(X.XBANLEQUAY_SL),SUM(X.XBANLEQUAY_GT),
         SUM(X.XBANLETL_SL), SUM(X.XBANLETL_GT),SUM(X.NMUA_SL),SUM(X.NMUA_GT),SUM(X.KIEMKE_SL),SUM(X.KIEMKE_GT),SUM(X.NHAPCHUYENKHO_SL),SUM(X.NHAPCHUYENKHO_GT),
         SUM(X.NHAPSTTHANHVIEN_SL),SUM(X.NHAPSTTHANHVIEN_GT),
         SUM(X.XUATCHUYENKHO_SL),SUM(X.XUATCHUYENKHO_GT),SUM(X.XUATSTTHANHVIEN_SL),SUM(X.XUATSTTHANHVIEN_GT),SUM(X.XBANLE_SL),SUM(X.XBANLE_GT),SUM(X.XUATBANBUON_SL),SUM(X.XUATBANBUON_GT),
         SUM(X.NHAPDIEUCHINH_SL),SUM(X.NHAPDIEUCHINH_GT),SUM(X.NHAPHANGAM_SL),SUM(X.NHAPHANGAM_GT),SUM(X.XUATHUYHH_SL),SUM(X.XUATHUYHH_GT),SUM(X.XUATHUY_SL),SUM(X.XUATHUY_GT),
         SUM(X.XUATTRANCC_SL),SUM(X.XUATTRANCC_GT),SUM(X.XUATDC_SL),SUM(X.XUATDC_GT),SUM(X.NHAPBANTL_SL),SUM(X.NHAPBANTL_GT),
         ...
         FROM ('||RESULT_STR||') X 
         GROUP BY X.MAVATTU,X.TENVATTU,X.MALOAIVATTU,X.MANHOMVATTU,X.UNITCODE,X.XBANLEQUAY_SL,X.XBANLEQUAY_GT,
         X.XBANLETL_SL, X.XBANLETL_GT,X.NMUA_SL,X.NMUA_GT,X.KIEMKE_SL,X.KIEMKE_GT,X.NHAPCHUYENKHO_SL,X.NHAPCHUYENKHO_GT,X.NHAPSTTHANHVIEN_SL,X.NHAPSTTHANHVIEN_GT,
         X.XUATCHUYENKHO_SL,X.XUATCHUYENKHO_GT,X.XUATSTTHANHVIEN_SL,X.XUATSTTHANHVIEN_GT,X.XBANLE_SL,X.XBANLE_GT,X.XUATBANBUON_SL,X.XUATBANBUON_GT,
         X.NHAPDIEUCHINH_SL,X.NHAPDIEUCHINH_GT,NHAPHANGAM_SL,X.NHAPHANGAM_GT,X.XUATHUYHH_SL,X.XUATHUYHH_GT,X.XUATHUY_SL,X.XUATHUY_GT,
         X.XUATTRANCC_SL,X.XUATTRANCC_GT,X.XUATDC_SL,X.XUATDC_GT,X.NHAPBANTL_SL,X.NHAPBANTL_GT';     
