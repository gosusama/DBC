    ...
    P_SQL_INSERT := 'INSERT INTO XUATNHAPTON_TEMP (MAVATTU, MALOAIVATTU, MANHOMVATTU,MANHACUNGCAP,MAKHO,SOLUONG,DONGIA,THANHTIEN,UNITCODE, LOAICHUNGTU,NGAYCHUNGTU,NGAYDUYETPHIEU)
         SELECT VATTUCHUNGTUCHITIET.MAHANG AS MAVATTU,
          ...
          FROM VATTUCHUNGTU
              ...
              INNER JOIN DMVATTU ON VATTUCHUNGTUCHITIET.MAHANG = DMVATTU.MAVATTU 
      ...
      P_SQL_INSERT := P_SQL_INSERT || ' UNION ALL
        ...
        UNION ALL
           ...
           UNION ALL
            ...
            FROM NVGDQUAY_ASYNCCLIENT gdquay
              ...
              INNER JOIN DMVATTU ON hanggdquay.MAVATTU = DMVATTU.MAVATTU 
            ...
            ON (kiemke.MAPHIEUKIEMKE = kiemkechitiet.MAPHIEUKIEMKE)
              INNER JOIN DMVATTU ON kiemkechitiet.MAVATTU = DMVATTU.MAVATTU 
        ...
        END;--End Tìm ky
         ...
         P_SQL_INSERT := P_SQL_INSERT || '
            ...
            INNER JOIN DMVATTU ON TDK.MAVATTU = DMVATTU.MAVATTU 
        ...
        P_TABLE_GROUPBY:= ' LEFT JOIN DMKHO F ON X.MAKHO = F.MAKHO ';
        ...
        P_TABLE_GROUPBY:= ' LEFT JOIN DMNHOMVATTU F ON X.MANHOMVATTU = F.MANHOMVTU ';
        ...
        P_TABLE_GROUPBY:= ' LEFT JOIN DMLOAIVATTU F ON X.MALOAIVATTU = F.MALOAIVATTU ';
        ...
        P_TABLE_GROUPBY:= 'LEFT JOIN DMKHACHHANG F ON X.MANHACUNGCAP = F.MAKH AND F.LOAIKHACHHANG =1';   
        ...
        P_TABLE_GROUPBY:= 'LEFT JOIN DMVATTU F ON X.MAVATTU = F.MAVATTU';   
